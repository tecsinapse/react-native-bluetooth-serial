package br.com.tecsinapse.BluetoothSerial;
...
import static br.com.tecsinapse.BluetoothSerial.BluetoothSerialPackage.TAG;
...
class BluetoothSerialService {
    ...
    private BluetoothSerialModule mModule;
    ...
    /**
     * Constructor. Prepares a new BluetoothSerialModule session.
     * @param module Module which handles service events
     */
    BluetoothSerialService(BluetoothSerialModule module) {
    ...
    private void connectionFailed() {
        ...
        BluetoothSerialService.this.stop(); // Start the service over to restart listening mode
    }
